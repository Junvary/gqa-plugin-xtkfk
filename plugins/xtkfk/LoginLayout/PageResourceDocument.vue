<template>
    <div class="q-pa-md row items-center justify-center gqa-resource-document" id="gqa-resource-document">
...
const { t } = useI18n()
const url = {
    list: 'public/plugin-xtkfk/get-document-list',
}
const columns = [
